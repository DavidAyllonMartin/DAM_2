...
class StarWarsCharactersDaoDbTest {

    private StarWarsCharactersDaoDb dao = null;

    @BeforeEach
    void SetUp(){
        this.dao = new StarWarsCharactersDaoDb();
        dao.createTable();
    }

    @Test
    void create() throws InvalidStarWarsParameterException, DataAccessException, DuplicateKeyException, IncompatibleVersionException {
        ...
        assertThrows(DuplicateKeyException.class, () -> dao.create(character));
    }

    @Test
    void read() throws InvalidStarWarsParameterException, IncompatibleVersionException, DataAccessException, DuplicateKeyException {
        StarWarsCharacter readCharacter = dao.read("Luke Skywalker");
    ...
    @Test
    void readAll() throws InvalidStarWarsParameterException, IncompatibleVersionException, DataAccessException, DuplicateKeyException {
    ...
    @Test
    void update() throws InvalidStarWarsParameterException, DataAccessException, DuplicateKeyException, IncompatibleVersionException {
        StarWarsCharacter character = new StarWarsCharacter.Builder()
                .name("Anakin Skywalker")
                .gender("male")
                .birthYear("41.9BBY")
    ...
    @Test
    void delete() throws InvalidStarWarsParameterException, DataIntegrityException, DataAccessException, DuplicateKeyException, IncompatibleVersionException {
        StarWarsCharacter character = new StarWarsCharacter.Builder()
                .name("Anakin Skywalker")
                .gender("male")
                .birthYear("41.9BBY")
